# Prompts de Imagem V2

1. Criar imagem para Produto Teste com padrão: UGC direto com prova visual. Mostrar dor: falta de clareza sobre o problema. Texto curto: melhorar a rotina em poucos passos.
